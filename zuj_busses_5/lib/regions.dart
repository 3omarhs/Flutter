...
class _RegionsState extends State<Regions> {
  ...
  void _launchURL1(var place_link) async {
    Navigator.push(context, MaterialPageRoute(builder: (context) => WebViewExample1(serverIP: place_link)));
  }

  _launchURL2(var place_link) async {
  ...
  void _launchURL(var place_link) async {
    ...
    Navigator.push(context, MaterialPageRoute(builder: (context) => WebViewExample(serverIP: place_link)));
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: TextButton.icon(
                                    onPressed: () {
                                      // _launchURL1(get_place().values.elementAt(i)[0]);
                                      _launchURL2(get_place().values.elementAt(i)[0]);
                                    },
                                    style: ButtonStyle(
