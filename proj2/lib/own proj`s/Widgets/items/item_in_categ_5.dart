...
class item_in_categ_5 extends StatelessWidget {
  final String img;
  const item_in_categ_5({Key? key, required this.img}) : super(key: key);
  @override
        ...
        children: [
          ...
          Positioned(
              ...
              child: Container(
                  width: 75,
                  height: 75,
                  decoration: BoxDecoration(borderRadius: BorderRadius.only(topLeft: Radius.circular(100), bottomRight: Radius.circular(15)),
