...
class MyWidgetState extends State<MyWidget> {
  ...
  static int CheckensNumber = 5, fallBroke = 0;
  ...
  static int screenWidth = (physicalScreenSize.width/3).toInt();
  List<int> eggPositions = [((screenWidth/5)-((screenWidth/5)/1.4)).toInt(), ((screenWidth*2/5)-((screenWidth/5)/1.4)).toInt(), ((screenWidth*3/5)-((screenWidth/5)/1.4)).toInt(), ((screenWidth*4/5)-((screenWidth/5)/1.4)).toInt(), ((screenWidth*5/5)-((screenWidth/5)/1.4)).toInt()];//57-103, 125-165, 187-227, 250-290, 305-345
  double preFallEggPosition = -10, endEggFall = 400, fallingegg = 0, yBas = 0;
  int countIn = 0, countOut = 0, oldEgg = egg, brokenEggsNumber = 100;
  ...
  void startGame(){
    int x = 100 + fallBroke;
    var duration = Duration(microseconds: x);
  ...
  Widget showEggs(){
    return Positioned(top: eggLocation, left: eggPositions[egg]+0.0,
        child: Image.asset('lib/Images/egg.png', width: 40, height: 40,));
  }

  Widget showBrokenEggs() {
    if ((broken == true)) {
      return Positioned(top: endEggFall, left: eggPositions[oldEgg] + 0.0,
          child: Image.asset('lib/Images/broken egg.png', width: 40, height: 40,));
    }
    else
      return Container();
  }
        ...
        Container(
          ...
          child: Column(children: [
            ...
            itemBuilder: (BuildContext context, int index){
              return Image.asset('lib/Images/chicken.png', width: 250, height: 250,);
            },
          )),
            Container(
              child: Container(
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: AnimatedContainer(
                            ...
                            child: Image.asset('lib/Images/basket.png', width: 150, height: 150,),
                        ),
                      ),
                    ),
                  ],
