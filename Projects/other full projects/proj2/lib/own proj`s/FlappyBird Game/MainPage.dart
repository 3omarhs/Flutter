...
import 'package:proj2/own%20proj%60s/FlappyBird%20Game/barriers.dart';
import 'package:proj2/own%20proj%60s/FlappyBird%20Game/bird.dart';
          ...
          body: Column(children: [
            Expanded(
                ...
                child: Stack(children: [
                  Image.asset('lib/own proj`s/FlappyBird Game/Images/bg.png', fit: BoxFit.fitHeight, height: double.infinity,),
                  AnimatedContainer(
                    key: containerKey1,
