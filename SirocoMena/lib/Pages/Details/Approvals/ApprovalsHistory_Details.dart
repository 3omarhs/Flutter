...
class App extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: ApprovalsHistory_Details(obj: items[1], ind: 0,),
    );
  }
}

class ApprovalsHistory_Details extends StatefulWidget {

  final obj;
  final int ind;
  const ApprovalsHistory_Details({super.key, required this.obj, this.ind=0});

  @override
  State<ApprovalsHistory_Details> createState() => _ApprovalsHistory_DetailsState();
}

class _ApprovalsHistory_DetailsState extends State<ApprovalsHistory_Details> {
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Container(alignment: Alignment.centerLeft, child: Text('Employee Note:')),
                  DetailsTextFormField(
                    initialValue: widget.obj['Employee Note'].toString(),
                    keyboard: TextInputType.datetime,
                  ),
                  ColumnEndSpace(),
                ],
