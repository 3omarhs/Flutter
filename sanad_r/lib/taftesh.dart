        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
                  ...
                  child: Form(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintStyle: TextStyle(fontFamily: 'NotoKufiArabic', fontSize: 18, ),
                    ...
                    children: [
                      TextButton(
                        ...
                        child: Text(
                          "متابعة",
                          style:
                              TextStyle(fontFamily: 'NotoKufiArabic', fontSize: 18, color: Color(0xFF023f54)),
                        ),
                      ),
                    ],
                  ),
              ...
              SizedBox(
                child: Container(
                  child: Text("أو قم بمسح الهوية عن طريق الكاميرا", style: TextStyle(fontFamily: 'NotoKufiArabic', fontSize: 18, color: Colors.white),),
                ),
              ),
                  ...
                  child: Column(
                    ...
                    children: [
                      TextButton(
                        ...
                        child: Text(
                          "مسح الهوية",
                          style: TextStyle(fontFamily: 'NotoKufiArabic', fontSize: 18, color: Color(0xFF023f54)),
                        ),
                      ),
                    ],
                  ),
              ...
              SizedBox(
                child: Container(
                  child: TextButton(
                    child: Text("مفتش", style: TextStyle(fontFamily: 'NotoKufiArabic', color: Colors.white, fontSize: 20),),
                    onPressed: (){
